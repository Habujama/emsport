...
const Footer: FC = () => {
  const link = classNames('underline hover:no-underline')
    return (
    <footer
    className="w-full px-8 py-12 bg-body-gradient text-white text-sm h-card"
  ...
  >
    ...
    <div className="row-start-2 sm:row-start-1 row-span-1 sm:col-start-1 col-span-1 flex flex-col">
        <address className="not-italic" id="kontakt">
          ...
          <p className="my-2">
            Tel.:&nbsp;<a href="tel:775710011" className={link}>+420&nbsp;775&nbsp;710&nbsp;011</a>
          </p>
          <p>
            E-mail:<br />
            <a href="mailto:info@kolaslany.cz?subject=Dotaz z webu" className={link}>info@kolaslany.cz</a><br />
            <a href="mailto:info@emsportslany.cz?subject=Dotaz z webu" className={link}>info@emsportslany.cz</a>
          </p>
        </address>
